...
class XlsxReport:
    ...
    def __add_styles_with_three_colors(self, style_name, style_dict):
    ...
    def __init_styles(self):
        ...
        main_descr_style = {'bold': False, 'font_name': 'Calibri', 'font_size': 10, 'text_wrap': True}
        ...
        self.__add_styles_with_three_colors("elementary_critical", elementary_critical_style)

        elementary_critical_style['align'] = 'right'
        self.__add_styles_with_three_colors("elementary_critical_icon", elementary_critical_style)

        elementary_status_style = {'font_name': 'Calibri', 'font_size': 11,
                                   'bottom': 6, 'top': 6,
                                   'text_wrap': True, 'align': 'center'}
        self.__add_styles_with_three_colors("elementary_status", elementary_status_style)
    ...
    def insert_main_header(self, main_title, scan_descr, sys_descr):
        ...
        self.worksheet.merge_range(self.current_row, self.start_column + 2, self.current_row, self.start_column + 4,
                                   scan_descr, self.__get_style("main_descr"))
        self.inc_current_row()
        #self.worksheet.write(self.current_row, self.start_column, scan_descr, self.__get_style("main_descr"))
        #self.inc_current_row()
